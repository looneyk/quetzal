...
#include "math/DimensionReducer.hpp"
#include "math/math_util.hpp"
#include "math/transformation_matrix.hpp" // change_of_basis ...
#include "geometry/Attributes.hpp" // flags ...
...
void quetzal::brep::connect(M& mesh, id_type idHalfedgeA, id_type idHalfedgeB, id_type idFaceA, id_type idFaceB)
{
    ...
    id_type idVertex0 = mesh.create_vertex(nh, halfedgeB.attributes());
    id_type idVertex1 = mesh.create_vertex(nh + 1, halfedgeA.attributes());

    mesh.create_halfedge(nh + 1, idHalfedgeA, idPrevB, idVertex0, idFaceA);
    mesh.create_halfedge(nh, idHalfedgeB, idPrevA, idVertex1, idFaceB);
