#if !defined(QUETZAL_FRAMEWORK_WINDOW_HPP)
#define QUETZAL_FRAMEWORK_WINDOW_HPP
//------------------------------------------------------------------------------
// quetzal framework
// Window.hpp
//------------------------------------------------------------------------------
...
namespace quetzal::framework
{
    ...
    public:
        ...
        void create_full(const std::string& title);
        void create_expanded(const std::string& title, double aspect_ratio, double position = 0.5f, bool bBorderless = true);
        void create_floating(const std::string& title, position_type position, size_type size, bool bBorderless = false, bool bMaximized = false, bool bMinimized = false);
...
#endif // QUETZAL_FRAMEWORK_WINDOW_HPP
