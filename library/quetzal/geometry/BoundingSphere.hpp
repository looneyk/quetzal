...
namespace quetzal::geometry
{
    ...
    public:
        ...
        void set_center(const point_type& center) const;
        void set_radius(value_type radius) const;
...
quetzal::geometry::BoundingSphere<Traits>::BoundingSphere() :
    BoundingSphere(point_type(), value_type(0))
{
}
