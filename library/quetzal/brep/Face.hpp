...
namespace quetzal::brep
{
    ...
    class Face : public Flags, public Properties
    {
    public:
        ...
        using holes_type = std::vector<id_type>;
    ...
    private:
        ...
        std::vector<id_type> m_idHalfedgeHoles;
